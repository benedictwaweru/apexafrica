...
import { cx, sortCx } from '@/shared/lib/cx';

import { Mastercard, MastercardWhite, PaypassIcon } from '../widgets/icons';
...
const styles = sortCx({
  ...
  'brand-dark': {
    root: 'bg-linear-to-tr from-[var(--primary)] to-[color:var(--primary)]/50 before:pointer-events-none before:absolute before:inset-0 before:z-1 before:rounded-[inherit] before:mask-linear-135 before:mask-linear-to-white/20 before:ring-1 before:ring-white/30 before:ring-inset',
    company: 'text-white',
    footerText: 'text-white',
    paypassIcon: 'text-white',
    cardTypeRoot: 'bg-white/10',
